 ...
 */
package byui.cit260.fireSwampGame.model;
...
public class Game implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 19 * hash + Objects.hashCode(this.getItem);
        hash = 19 * hash + (int) (Double.doubleToLongBits(this.getMap) ^ (Double.doubleToLongBits(this.getMap) >>> 32));
        hash = 19 * hash + (int) (Double.doubleToLongBits(this.saveGame) ^ (Double.doubleToLongBits(this.saveGame) >>> 32));
        hash = 19 * hash + (int) (Double.doubleToLongBits(this.loadGame) ^ (Double.doubleToLongBits(this.loadGame) >>> 32));
        return hash;
    }
